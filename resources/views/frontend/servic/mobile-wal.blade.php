...
@section('content')
<main>
    <section class="country-specific" style="background:url('images/img/upesi/money-trans-bg.jpg');">
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <section id="description">
                        ...
                        <p class="text-center">Receive money on your phone instantly through our mobile money partners in Kenya, Uganda and UK.
                        </p>
